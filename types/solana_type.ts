...
export interface EvmProvider extends Provider {
  ...
  isConnected(): boolean
  send(
    rpcRequestOrMethod: RpcRequest | RpcRequest['method'],
    callbackOrParams: SendCallback | RpcRequest['params']
  ): void
...
export interface WalletStandardWallet {
  ...
  disconnect(): Promise<void>
  signMessage(
    ...inputs: { account: WalletStandardAccount; message: Uint8Array }[]
  ): Promise<
    {
...
export type WalletStandardRegisterApiCallback = (
  api: WalletStandardRegisterApi
) => void
