...
let walletConnectRequestsDelayTimeout: ReturnType<typeof setTimeout>
const REQUEST_DELAY_TIME = 2000

let unblockWalletConnectEventsTimeout: ReturnType<typeof setTimeout>
...
export const blockWalletConnectEvents = async (
  ...
  try {
    ...
    unblockWalletConnectEventsTimeout = setTimeout(
      unblockWalletConnectRequests,
      UNBLOCK_TIME
    )
  }
}
