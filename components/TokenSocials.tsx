...
const getSocialType = (url: string): 'twitter' | 'x' | 'telegram' | 'discord' | 'medium' | 'other' => {
  if (!url) return 'other'
  ...
  return (
    <View className="flex-row items-center">
      <TouchableOpacity
        ...
        className="mr-2 px-3 py-2 bg-dark-200 rounded-5xl flex-row gap-2"
      >
        <Ionicons name={iconName as any} size={22} color="#818cf8" />
      </TouchableOpacity>
    </View>
  )
}
