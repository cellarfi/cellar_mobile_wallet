...
// Token Selector Card Component - similar to swap screen
...
const PostComposer: React.FC<PostComposerProps> = ({
  ...
  useEffect(() => {
    // This will be handled by the parent component that manages the form
    // The search modal will set the parameters and the parent will handle them
    // We'll use a simpler approach - the parent component will pass the selected token
  }, [])
  ...
  }, [mediaItems, handleMediaPick, removeMedia, uploading])
