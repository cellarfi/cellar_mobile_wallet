...
export default function SocialScreen() {
  ...
  }, [socialPosts, trendingPosts, personalizedPosts, activeTab, postTypeFilter])
  ...
  const renderListHeader = () => (
    <View>
      ...
      <TouchableOpacity
        className='bg-secondary-light rounded-xl p-3 mb-6 mx-6 flex-row items-center border'
        activeOpacity={0.85}
