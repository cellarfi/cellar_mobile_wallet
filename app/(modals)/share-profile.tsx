  ...
  return (
    <SafeAreaView className="flex-1 bg-dark-50">
      ...
      <ScrollView className="flex-1 p-6">
        {/* Profile Card */}
        <View className="w-full bg-dark-100 rounded-2xl p-6 items-center mb-6">
        ...
        <View className="w-full mb-6">
          ...
          <View className="flex-row items-center bg-dark-100 rounded-xl p-3">
            <Text
        ...
        {/* Share Button */}
        <TouchableOpacity
          className="flex-row items-center justify-center bg-primary-500 py-4 rounded-xl w-full"
          onPress={handleShare}
        >
        ...
        <View className="mt-8">
          ...
          <View className="flex-row justify-center space-x-6">
            {socialIcons.map((icon) => (
              <TouchableOpacity
                key={icon.name}
                className="w-12 h-12 bg-dark-100 rounded-full items-center justify-center"
              >
