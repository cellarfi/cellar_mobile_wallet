        ...
        <View className="flex-1">
          ...
          >
            ...
            <View className="px-6 mb-8">
              ...
              <View className="items-center justify-center flex-row px-6 mb-8">
                {['website', 'twitter', 'telegram', 'discord', 'medium'].map((key) => {
                  const link = tokenOverview.extensions?.[key as keyof typeof tokenOverview.extensions];
